...
class C_KetuaJurusan extends Controller
{
    ...
    public function detail($id_pegawai)
    {
        ...
        $data = [
            'title'     => 'Data Ketua Jurusan',
            'subTitle'  => 'Detail Ketua Jurusan',
            'biodata'   => $this->ModelSetting->detail(1),
            'user'      => $this->ModelUser->detail(Session()->get('id_user')),
            'detail'    => $this->ModelPegawai->detail($id_pegawai)
        ];

        return view('admin.ketuaJurusan.detail', $data);
    }
    ...
    public function add()
    {
        ...
        $data = [
            'title'     => 'Data Ketua Jurusan',
            'subTitle'  => 'Tambah Ketua Jurusan',
            'biodata'   => $this->ModelSetting->detail(1),
            'user'      => $this->ModelUser->detail(Session()->get('id_user'))
        ];

        return view('admin.ketuaJurusan.add', $data);
    }
    ...
    public function addProcess()
    {
        ...
        return redirect()->route('kelola-ketua-jurusan')->with('berhasil', 'Data Ketua Jurusan berhasil ditambahkan !');
    }
    ...
    public function edit($id_pegawai)
    {
        ...
        $data = [
            'title'     => 'Data Ketua Jurusan',
            'subTitle'  => 'Edit Ketua Jurusan',
            'biodata'   => $this->ModelSetting->detail(1),
            'user'      => $this->ModelUser->detail(Session()->get('id_user')),
            'detail'    => $this->ModelPegawai->detail($id_pegawai)
        ];

        return view('admin.ketuaJurusan.edit', $data);
    }
    ...
    public function editProcess($id_pegawai)
    {
        ...
        return redirect()->route('kelola-ketua-jurusan')->with('berhasil', 'Data Ketua Jurusan berhasil diedit !');
    }
    ...
    public function deleteProcess($id_pegawai)
    {
        ...
        return redirect()->route('kelola-ketua-jurusan')->with('berhasil', 'Data Ketua Jurusan berhasil dihapus !');
    }
}
