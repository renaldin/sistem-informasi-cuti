...
class C_PengajuanCuti extends Controller
{
    ...
    public function sendPengajuanCuti($id_pengajuan_cuti)
    {
    ...
    public function deleteProcess($id_pengajuan_cuti)
    {
        ...
        return redirect()->route('pengajuan-cuti')->with('berhasil', 'Data pegawai berhasil dihapus !');
    }
    // tutup pegawai

    // admin
    public function managePengajuanCuti()
    {
        if (!Session()->get('email')) {
            return redirect()->route('login');
        }
