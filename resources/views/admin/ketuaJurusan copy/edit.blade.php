                ...
                <div class="form-box">
                    ...
                    <div class="form-content">
                        <div class="contact-form-action">
                            <form action="/edit-wakil-direktur/{{$detail->id_pegawai}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="email" name="email" placeholder="Masukkan Email" value="{{ $detail->email }}" autofocus>
                                            </div>
                                            @error('email')
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <label class="label-text"><strong>Data Wakil Direktur</strong></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="nama" placeholder="Masukkan Nama Lengkap" value="{{ $detail->nama }}" >
                                            </div>
                                            @error('nama')
                                            <div style="margin-top: -16px">
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="jabatan" placeholder="Masukkan Jabatan" value="{{ $detail->jabatan }}">
                                            </div>
                                            @error('jabatan')
                                            <div style="margin-top: -16px">
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="masa_kerja" placeholder="Masukkan Masa Kerja" value="{{ $detail->masa_kerja }}">
                                            </div>
                                            @error('masa_kerja')
                                            <div style="margin-top: -16px">
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="keterangan_n_2" placeholder="Masukkan Keterangan N-2" value="{{ $detail->keterangan_n_2 }}">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="keterangan_n_1" placeholder="Masukkan Keterangan N-1" value="{{ $detail->keterangan_n_1 }}">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="keterangan_n" placeholder="Masukkan Keterangan N" value="{{ $detail->keterangan_n }}">
                                            </div>
                                            @error('keterangan_n')
                                            <div style="margin-top: -16px">
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="col-lg-12 mt-3 text-center">
                                    <a href="/kelola-wakil-direktur" class="theme-btn theme-btn-small theme-btn-transparent">Kembali</a>
