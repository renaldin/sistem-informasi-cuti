                ...
                <div class="form-box">
                    ...
                    <div class="form-content">
                        <div class="contact-form-action">
                            <form action="/edit-ketua-jurusan/{{$detail->id_pegawai}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <label class="label-text"><strong>Data Ketua Jurusan</strong></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 text-center">
                                    <a href="/kelola-ketua-jurusan" class="theme-btn theme-btn-small theme-btn-transparent">Kembali</a>
