...
{{-- Hapus --}}
@foreach ($dataUser as $item)
<div class="modal fade" id="hapus{{ $item->id_user }}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            ...
            <a href="/hapus-user/{{ $item->id_user }}" class="btn btn-danger">Hapus</a>
        </div>
        </div>
    </div>
</div>
