                        ...
                        <div class="table-form table-responsive">
                            ...
                            <table class="table" id="example2">
                                ...
                                <tbody>
                                    ...
                                    @if ($item->status_pengajuan === 'Dikirim ke Atasan')
                                        <tr>
                                            <td colspan="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <a href="/detail-pengajuan-cuti-atasan/{{ $item->id_pengajuan_cuti }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="Detail"><i class="la la-eye"></i></a>
                                                    @if ($item->status_pengajuan === 'Diterima Atasan')
                                                        <button type="button" data-toggle="modal" data-target="#izin-atasan{{$item->id_pengajuan_cuti}}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="Beri Izin"><i class="la la-check"></i></button>
                                                    @endif
...
<div class="modal fade" id="terima{{ $item->id_pengajuan_cuti }}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
            <a href="/terima-pengajuan-cuti-atasan/{{ $item->id_pengajuan_cuti }}" class="btn btn-primary">Terima</a>
        </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="izin-atasan{{ $item->id_pengajuan_cuti }}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
            <a href="/izin-atasan/{{ $item->id_pengajuan_cuti }}" class="btn btn-primary">Beri Izin</a>
        </div>
        </div>
    </div>
</div>
