                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <a href="/detail-pengajuan-cuti-pejabat/{{ $item->id_pengajuan_cuti }}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="Detail"><i class="la la-eye"></i></a>
                                                    @if ($item->status_pengajuan === 'Diterima Pejabat')
                                                        <button type="button" data-toggle="modal" data-target="#izin-pejabat{{$item->id_pengajuan_cuti}}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="Beri Izin"><i class="la la-check"></i></button>
                                                    @endif
...
{{-- beri izin --}}
@foreach ($dataPengajuanCuti as $item)
<div class="modal fade" id="izin-pejabat{{ $item->id_pengajuan_cuti }}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
