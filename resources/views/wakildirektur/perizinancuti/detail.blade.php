                        ...
                        <div class="contact-form-action">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-12 mt-3 text-center">
                                    <a href="@if($user->role == 'Pegawai') /pengajuan-cuti @elseif($user->role == 'Ketua Jurusan') /pengajuan-cuti-ketua-jurusan @elseif($user->role == 'Wakil Direktur 2') /perizinan-cuti-wakil-direktur2 @endif" class="theme-btn theme-btn-small theme-btn-transparent">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
